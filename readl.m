%Version L
%
%This version will be used to study the stratified flow cases for
%Richardson numbers from 0.1 to 10
%
%**************************************************************************
...
ax = gca;
ax.XTick = [-pi/6 0 pi/6];
ax.YTick = [-pi/6 0 pi/6];
ax.ZTick = [-pi/6 0 pi/6];
ax.XLim = [-pi/6 pi/6];
ax.YLim = [-pi/6 pi/6];
ax.ZLim = [-pi/6 pi/6];
ax.XTickLabel = {'-\pi/6','0','\pi/6'};
ax.YTickLabel = {'-\pi/6','0','\pi/6'};
ax.ZTickLabel = {'-\pi/6','0','\pi/6'};
grid on;
hold on;
